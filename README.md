...
kernel — small on purpose — and it is **self-verified by 374 checks** that the language can only ever
grow *greener* (every new feature must keep them all passing).

```console
$ python3 run_tests.py
...
PASS — 374/374 citadel checks
```
...
first pure operations, `i31.add` and `i31.sub`, preserve LOOM's tagged i31
