...
kernel — small on purpose — and it is **self-verified by 185 checks** that the language can only ever
grow *greener* (every new feature must keep them all passing).

```console
$ python3 run_tests.py
...
PASS — 185/185 citadel checks
```
